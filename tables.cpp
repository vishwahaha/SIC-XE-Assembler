...
typedef map<string, label_struct> SYMBOL_TABLE_TYPE;
typedef map<string, opcode_struct> OPCODE_TABLE_TYPE;
typedef map<string, register_struct> REG_TABLE_TYPE;
typedef map<string, literal_struct> LIT_TABLE_TYPE;
typedef map<string, blocks_struct> BLOCK_TABLE_TYPE;
...
void load_BLOCKS()
{
  ...
  BLOCKS["DEFAULT"].start_address = "00000";
